% --------------------------------------------------------------------------------------------------------------
% Weina_Norm_ENhuan - Improved Wiener filtering with noise estimation
%
% This function performs Wiener filtering with improved noise estimation to enhance speech signals.
%
% Syntax: enhanced = Weina_Norm_ENhuan(x, wind, inc, NIS)
%
% Inputs:
...
function enhanced = Weina_Norm_ENhuan(x, wind, inc, NIS)
    ...
    for i = 1:framenum
        ...
        Hw = (smoothed_signal ./ (smoothed_signal + noise)).^1;
