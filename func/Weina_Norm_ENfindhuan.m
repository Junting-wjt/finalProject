% --------------------------------------------------------------------------------------------------------------
% Weina_Norm_ENfindhuan - Improved parametric Wiener filtering with noise estimation
%
% This function performs Wiener filtering with improved noise estimation and parametric adjustments
% to enhance speech signals. 
%
% Syntax: enhanced = Weina_Norm_ENfindhuan(x, wind, inc, NIS, alpha, beta)
%
% Inputs:
...
function enhanced = Weina_Norm_ENfindhuan(x, wind, inc, NIS, alpha, beta)
    ...
    for i = 1:framenum
        ...
        % Spectral subtraction with parametric control
        for k = 1:framesize
