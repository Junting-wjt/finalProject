% --------------------------------------------------------------------------------------------------------------
% Weina_Norm_OPP - Parametric Wiener filtering without improved noise estimation
%
% This function performs parametric Wiener filtering to enhance speech signals without improved noise estimation.
%
% Syntax: enhanced = Weina_Norm_OPP(x, wind, inc, NIS, alpha, beta)
%
% Inputs:
...
function enhanced = Weina_Norm_OPP(x, wind, inc, NIS, alpha, beta)
