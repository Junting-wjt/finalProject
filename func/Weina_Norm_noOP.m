% --------------------------------------------------------------------------------------------------------------
% Weina_Norm_noOP - Basic Wiener filtering without optimization
%
% This function performs basic Wiener filtering to enhance speech signals.
%
% Syntax: enhanced = Weina_Norm_noOP(x, wind, inc, NIS)
%
% Inputs:
...
function enhanced = Weina_Norm_noOP(x, wind, inc, NIS)
